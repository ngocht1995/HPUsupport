...
?>
	<tr<?php echo $intro_article->RowAttributes() ?>>
            <td> 
                <p class="phead_thongbao"><b> <a title="Văn phòng hỗ trợ trực tuyến - Support Online" href="<?php echo $url  ?>" class="ahead_thongbao"  ><?php echo $intro_article->tieude_baiviet->ListViewValue() ?><br> <span id="spanthoigian1" style="color:#94ff07;font-weight: bold;font-size: 11px">(Thời gian: Từ ngày: <?php echo $begin_date_view ?> Đến ngày:  <?php echo $end_date_view ?>)</span></a><?php echo $img ?></b> </p><br>
            </td>
	</tr>
<?php
	}
...
<?php if ($intro_article->CurrentAction <> "gridadd" && $intro_article->CurrentAction <> "gridedit") { ?>
     ...
     <table border="0" cellspacing="0" cellpadding="0" class="ewPager" width="100%" style="float: right;margin: 10px 0px 10px 0px">
                <tr>
                    ...
                    <span class="phpmaker" style="color:white;"  >
            <?php if (!isset($intro_article_list->Pager)) $intro_article_list->Pager = new cNumericPager($intro_article_list->lStartRec, $intro_article_list->lDisplayRecs, $intro_article_list->lTotalRecs, $intro_article_list->lRecRange) ?>
            <?php if ($intro_article_list->Pager->RecordCount > 0) { ?>
                 ...
                 <?php echo $intro_article_list->Pager->FromIndex ?> to <?php echo $intro_article_list->Pager->ToIndex ?> of <?php echo $intro_article_list->Pager->RecordCount ?>
            <?php } else { ?>	
