...
<?php
 ...
 $c_namhoc=KillChars(htmlspecialchars($_POST['c_namhoc'],ENT_QUOTES));
 $c_hocky=KillChars(htmlspecialchars($_POST['c_hocky'],ENT_QUOTES));
 $c_lanthi=KillChars(htmlspecialchars($_POST['c_lanthi'],ENT_QUOTES));
...
Function Get_arrayservice_array ($para,$name_modul)
{
            ...
            // Cài đặt hỗ trợ WSDL
                $wsdl = "http://10.1.0.238:8082/HPUWebService.asmx?wsdl";
